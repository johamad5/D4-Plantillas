...
app.get('/products', (req, res) => {
  stock.length > 0 ? res.render('pages/productsList', { products: stock, exists: true }) : res.render('msg', { msg: 'Lo sentimos, no tenemos productos disponibles por el momento!' });
});
...
app.post('/products', (req, res) => {
  ...
  stock.push({ id, ...body });
  console.log(stock);
  res.render('pages/msg', { msg: 'Producto agregado!' });
});
