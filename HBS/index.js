...
app.engine(
  ...
  engine({
    extname: '.hbs',
    defaultLayout: 'index.hbs', // Base de la vista
    layoutsDir: __dirname + '/views/layouts', // Ruta de los layouts
    partialsDir: __dirname + '/views/partials', // Ruta de los partials
  })
);
...
app.get('/products', (req, res) => {
  stock.length > 0 ? res.render('productsList', { products: stock, exists: true }) : res.render('msg', { msg: 'Lo sentimos, no tenemos productos disponibles por el momento!' });
});
